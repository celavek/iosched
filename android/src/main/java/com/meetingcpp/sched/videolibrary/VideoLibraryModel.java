...
package com.meetingcpp.sched.videolibrary;
...
import com.meetingcpp.sched.util.ParserUtils;
 ...
 * {@link com.meetingcpp.sched.framework.PresenterFragmentImpl}.
 */
public class VideoLibraryModel implements Model {

    private static final String TAG = makeLogTag(VideoLibraryModel.class);

    protected static final String KEY_YEAR = "com.meetingcpp.sched.KEY_YEAR";

    protected static final String KEY_TOPIC = "com.meetingcpp.sched.KEY_TOPIC";

    protected static final String KEY_VIDEO_ID = "com.meetingcpp.sched.KEY_VIDEO_ID";
