...
package com.meetingcpp.sched.map;

import com.meetingcpp.sched.R;
import com.meetingcpp.sched.provider.ScheduleContract;
import com.meetingcpp.sched.session.SessionDetailConstants;
...
/**
 * Activity that displays a {@link com.meetingcpp.sched.map.MapFragment} and a {@link
 * com.meetingcpp.sched.map.MapInfoFragment}.
 ...
 * marker.
 *
 * @see com.meetingcpp.sched.map.MapInfoFragment#newInstace(android.content.Context)
 */
public class MapActivity extends BaseActivity
     ...
     */
    public static final String EXTRA_ROOM = "com.google.android.extra.ROOM";

    public static final String EXTRA_DETACHED_MODE
            = "com.meetingcpp.sched.EXTRA_DETACHED_MODE";
     ...
     * applied to the map.
     *
     * For {@link com.meetingcpp.sched.map.InlineInfoFragment} (that is only displayed
     * on the left of the screen), the full extend of its container layout (including padding) is
     * passed to the map fragment.
     * For {@link com.meetingcpp.sched.map.SlideableInfoFragment} (that is only
     * displayed
