...
package com.meetingcpp.sched.settings;
...
public class SettingsUtils {
     ...
     * {@code com.meetingcpp.sched.ui.BaseActivity.performDataBootstrap installed} the
    ...
    /**
     * Return true if the
     * {@code com.meetingcpp.sched.welcome.WelcomeActivity.displayDogfoodWarningDialog() Dogfood Build Warning}
     ...
     * {@link com.meetingcpp.sched.welcome.ConductFragment Conduct}, false if they haven't (yet).
     *
     * @param context Context to be used to lookup the {@link android.content.SharedPreferences}.
     */
     ...
     * Managed by {@link com.meetingcpp.sched.ui.BaseActivity the}
     * {@link com.meetingcpp.sched.core.activities.BaseActivity two} base activities.
     *
     * @param context  Context to be used to edit the {@link android.content.SharedPreferences}.
     * @param newValue New value that will be set.
     */
