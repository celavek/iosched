...
import com.meetingcpp.sched.model.TagMetadata;
...
import com.meetingcpp.sched.ui.SearchActivity;
...
import com.meetingcpp.sched.util.AnalyticsHelper;
import com.meetingcpp.sched.util.UIUtils;

import java.util.List;

import static com.meetingcpp.sched.ui.widget.CollectionView.Inventory;
import static com.meetingcpp.sched.ui.widget.CollectionView.InventoryGroup;
import static com.meetingcpp.sched.ui.widget.CollectionView.OnClickListener;
...
public class ExploreSessionsActivity extends BaseActivity
    ...
    public static final String EXTRA_FILTER_TAG =
            "com.meetingcpp.sched.explore.EXTRA_FILTER_TAG";
    public static final String EXTRA_SHOW_LIVE_STREAM_SESSIONS =
            "com.meetingcpp.sched.explore.EXTRA_SHOW_LIVE_STREAM_SESSIONS";

    // The saved instance state filters
    private static final String STATE_FILTER_TAGS =
            "com.meetingcpp.sched.explore.STATE_FILTER_TAGS";
    private static final String STATE_CURRENT_URI =
            "com.meetingcpp.sched.explore.STATE_CURRENT_URI";
     ...
     * {@link com.meetingcpp.sched.model.TagMetadata}
     */
