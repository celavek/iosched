 ...
 */
package com.meetingcpp.sched.server.gcm.db;
...
import static com.meetingcpp.sched.server.gcm.db.OfyService.ofy;
...
public final class MessageStore {
    ...
    public static MulticastMessage getMulticast(Long id) {
        return ofy().load().type(MulticastMessage.class).id(id).now();
    }
    ...
    public static void updateMulticast(Long id, List<String> devices) {
        MulticastMessage msg = ofy().load().type(MulticastMessage.class).id(id).now();
        if (msg == null) {
