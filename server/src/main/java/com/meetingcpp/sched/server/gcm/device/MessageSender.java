...
package com.meetingcpp.sched.server.gcm.device;

import com.meetingcpp.sched.server.gcm.db.ApiKeyInitializer;
import com.meetingcpp.sched.server.gcm.db.MessageStore;
import com.meetingcpp.sched.server.gcm.db.DeviceStore;
import com.meetingcpp.sched.server.gcm.db.models.Device;
import com.meetingcpp.sched.server.gcm.db.models.MulticastMessage;
...
public class MessageSender {
    ...
    boolean sendMessage(Long multicastId) {
        ...
        try {
            // We occasionally see null messages. (Maybe due to squelch?)
